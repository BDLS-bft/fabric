...
func (f *FabricLogger) DPanic(args ...interface{}) { f.s.DPanic(formatArgs(args)) }
...
func (f *FabricLogger) Warn(args ...interface{}) { f.s.Warn(formatArgs(args)) }
...
func (f *FabricLogger) Warning(args ...interface{})                { f.s.Warn(formatArgs(args)) }
